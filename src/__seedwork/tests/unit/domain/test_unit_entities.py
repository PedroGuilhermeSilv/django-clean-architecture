...
class TestEntityUnit(unittest.TestCase):
    ...
    def test_account_a_valid_uuid(self):
        entity = StubEntity(
            unique_entity_id="2506e4ca-4cda-4e2e-ae87-763208d223c3",
            prop1="prop1",
            prop2="prop2",
        )
        self.assertEqual(
            entity.unique_entity_id, "2506e4ca-4cda-4e2e-ae87-763208d223c3"
        )
    ...
    def test_metod_to_dict(self):
        ...
        self.assertDictEqual(
            entity.to_dict(),
            {
                "id": "2506e4ca-4cda-4e2e-ae87-763208d223c3",
                "prop1": "prop1",
                "prop2": "prop2",
            },
        )
    ...
    def test_method_set(self):
        entity = StubEntity(prop1="prop1", prop2="prop2")
        entity._set("prop1", "new prop1")
        self.assertEqual(entity.prop1, "new prop1")
